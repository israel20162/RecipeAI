...
INSERT INTO "new_Recipe" ("authorId", "categoryId", "createdAt", "description", "difficulty", "downvotes", "id", "imageUrl", "instructions", "is_featured", "rating", "time_to_prepare", "title", "updatedAt", "upvotes", "youtube_link") SELECT "authorId", "categoryId", "createdAt", "description", "difficulty", "downvotes", "id", "imageUrl", "instructions", "is_featured", "rating", "time_to_prepare", "title", "updatedAt", "upvotes", "youtube_link" FROM "Recipe";
DROP TABLE "Recipe";
